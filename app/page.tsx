              ...
              {funds.map((f) => {
                ...
                return (
                  <tr key={f.id}>
                    ...
                    <td className="num" data-label="Committed"><Fig value={s?.commitments} fmt={fmtMoneyM} missing={missingReason(s, "Total Commitments", fb)} /></td>
                    ...
                    <td className="num" data-label="NAV"><Fig value={s?.nav} fmt={fmtMoneyM} missing={missingReason(s, "NAV", fb)} /></td>
